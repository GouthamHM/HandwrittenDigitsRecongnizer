...
if __name__ == "__main__":
    ...
    train_x_file = "./data/train-images.idx3-ubyte"
    train_matrix= data_sorting(train_x_file,60000)
    print (train_matrix.shape)

    train_y_file = "./data/train-labels.idx1-ubyte"
    train_label = label_list(train_y_file)
    print(train_label.shape)

    train_x_file = "./data/t10k-images.idx3-ubyte"
    test_matrix = data_sorting(train_x_file,10000)
    print(test_matrix.shape)

    train_y_file = "./data/t10k-labels.idx1-ubyte"
